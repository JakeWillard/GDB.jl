...
function leapfrog!(lnn, lnTe, lnTi, u, w, A, phi, psi, n, Te, Ti, Pe, Pi, j, jn, wrk::Workspace)
    ...
    for _=1:wrk.N_subcycle
        ...
        lnTe_ss = partial_ss(lnTe[:,2], lnTe_s, lnTe_x, lnTe_y, lnTe_xy, lnTe_xx, lnTe_yy, psi_x, psi_y, psi_xy, psi_xx, psi_yy, wrk.Dss, wrk.Ds, wrk.Dx, wrk.Dy, am)
    ...
    for _=1:wrk.N_subcycle
        ...
        lnTi_ss = partial_ss(lnTi[:,2], lnTi_s, lnTi_x, lnTi_y, lnTi_xy, lnTi_xx, lnTi_yy, psi_x, psi_y, psi_xy, psi_xx, psi_yy, wrk.Dss, wrk.Ds, wrk.Dx, wrk.Dy, am)
    ...
    G_y = wrk.Dy*G
    G_c = -2*G_y[:]
    G_s = partial_s(G, G_x, G_y, psi_x, psi_y, wrk.Ds, am)
